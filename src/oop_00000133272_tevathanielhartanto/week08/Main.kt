...
fun main() {
    ...
    for (item in mixedData) {
        ...
        // Hanya cetak jika cast sukses (text tidka null)
        text?.let {
    ...
    // Coba cast ke String. Jika gagal (null), gnati dengan "Unknow String"
    ...
    // Kita menakan tombol !! karena KITA TAHU implementasi Java-nya aman
